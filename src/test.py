...
def run_test_of_single_fold(config, output_dir, fold_idx, data_loader):
    ...
    model_path = f'{output_dir}/baseline/model_best.pth'
...
def main(config, output_dir, num_fold=1):
    ...
    # generate submission
    all_alert_keys = pd.read_csv('../raw_dataset/sample.csv').alert_key
...
if __name__ == '__main__':
    ...
    args.add_argument('-o', '--output_dir', default='../save_dir/', type=str,
                      help='output_dir')
